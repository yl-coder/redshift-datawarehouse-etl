...
user_table_insert = ("INSERT INTO users(user_id, first_name, last_name, gender, level) SELECT userId as user_id, firstName as first_name, lastName as last_name, gender, level from stg_events WHERE user_id IS NOT NULL")
...
time_table_insert = ("INSERT INTO time(start_time, hour, day, week, month, year, weekday) SELECT ts as start_time, \
